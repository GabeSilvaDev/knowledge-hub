...
it('returns top ranked articles', function (): void {
    ...
    $response = $this->getJson('/api/articles/ranking?limit=3');
...
it('returns ranking statistics', function (): void {
    ...
    $response = $this->getJson('/api/articles/ranking/statistics');
...
it('syncs ranking from database', function (): void {
    ...
    $response = $this->actingAs($user)->postJson('/api/articles/ranking/sync');
...
it('shows article ranking info', function (): void {
    ...
    $response = $this->actingAs($user)
        ->getJson("/api/articles/{$article->id}/ranking");
...
it('returns empty ranking when no articles viewed', function (): void {
    $response = $this->getJson('/api/articles/ranking');
...
it('limits ranking results correctly', function (): void {
    ...
    $response = $this->getJson('/api/articles/ranking?limit=5');
